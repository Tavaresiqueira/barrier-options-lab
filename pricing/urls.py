...
urlpatterns = [
    ...
    path("api/v1/barriers/snapshot/", views.barrier_snapshot, name="barrier_snapshot"),
    path("api/v1/barriers/monitoring-equivalence/", views.barrier_monitoring_equivalence, name="barrier_monitoring_equivalence"),
